...
// Récupérer les informations utilisateur si connecté (pour le header)
$user = null;
...
if (isset($user['profile_picture']) && !empty($user['profile_picture'])) {
    $profile_picture_path = getCorrectImagePath($user['profile_picture'], $base_path);
}
?>
<!DOCTYPE html>
                ...
                <div class="flex items-center">
                    <a href="<?php echo $base_path; ?>index.php" class="text-2xl font-bold flex items-center group">
                        ...
                        <span class="ml-2 font-serif text-xl bg-clip-text text-transparent bg-gradient-to-r from-gold-400 to-gold-500">
                            Bibliothèque <span class="hidden md:inline">Chrétienne</span>
                        </span>
                    </a>
                </div>
