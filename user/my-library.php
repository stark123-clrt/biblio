...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Ma Espace de livre</h1>
            ...
            <div class="md:w-1/4 mb-4 md:mb-0">
                <div class="text-center">
                    <?php if (!empty($user['profile_picture'])): ?>
                        <img src="<?php echo $user['profile_picture']; ?>" alt="Photo de profil" class="w-32 h-32 rounded-full mx-auto object-cover">
                    <?php else: ?>
                    ...
                    <?php endif; ?>
                    <div class="mt-2 font-bold"><?php echo htmlspecialchars($user['username']); ?></div>
                </div>
            </div>
            
            <div class="md:w-3/4 md:pl-6">
    <h2 class="text-xl font-bold mb-4">Statistiques de lecture</h2>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-blue-50 p-4 rounded text-center">
            <div class="text-3xl font-bold text-blue-800"><?php echo count($library_books); ?></div>
            <div class="text-gray-600">Livres dans ma bibliothèque</div>
        </div>
        <div class="bg-green-50 p-4 rounded text-center">
            <div class="text-3xl font-bold text-green-800"><?php echo $reading_stats['started_books']; ?></div>
            <div class="text-gray-600">Livres commencés</div>
        </div>
        <div class="bg-purple-50 p-4 rounded text-center">
            ...
            ?>
            <div class="text-3xl font-bold text-purple-800"><?php echo $completed_books; ?></div>
            <div class="text-gray-600">Livres terminés</div>
        </div>
        <div class="bg-yellow-50 p-4 rounded text-center">
            ...
            <div class="text-gray-600">Notes prises</div>
        </div>
    </div>
</div>
        </div>
    ...
    <div class="flex flex-wrap justify-between items-center mb-6">
        <div class="w-full md:w-auto mb-4 md:mb-0">
            <div class="flex space-x-2">
                ...
                <button class="filter-btn px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg" data-filter="reading">
                    En cours
                </button>
                <button class="filter-btn px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg" data-filter="favorites">
                    Favoris
                </button>
                <button class="filter-btn px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg" data-filter="not-started">
                    Non commencés
                </button>
            </div>
        </div>
    ...
    <div id="libraryBooks" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        <?php if (!empty($library_books)): ?>
            <?php foreach ($library_books as $book): ?>
                ...
                ?>
                <!-- Modification des cartes de livre dans la section "Liste des livres" -->

<!-- Remplacer le div existant dans la boucle foreach par celui-ci -->
<div class="library-book bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 <?php echo $book_status; ?>" data-title="<?php echo htmlspecialchars(strtolower($book['title'])); ?>">
    <div class="relative">
        ...
        <!-- Bouton favori -->
        <button class="favorite-btn absolute top-2 right-2 text-xl text-yellow-500 bg-white bg-opacity-80 w-8 h-8 rounded-full flex items-center justify-center" data-id="<?php echo $book['id']; ?>" data-favorite="<?php echo $book['is_favorite'] ? '1' : '0'; ?>">
    ...
    <div class="p-4">
        <div class="flex justify-between items-start mb-2">
            <div>
                ...
                <div class="text-xs text-gray-600 mb-1"><?php echo htmlspecialchars($book['category_name'] ?? 'Non catégorisé'); ?></div>
            </div>
        </div>
        ...
        <div class="mt-2 text-center">
            <button class="remove-book-btn text-red-600 hover:text-red-800 text-sm" data-id="<?php echo $book['id']; ?>" data-title="<?php echo htmlspecialchars($book['title']); ?>">
        ...
        <?php else: ?>
            <div class="col-span-full text-center py-10">
                ...
                <h2 class="text-2xl font-bold text-gray-700 mb-2">Votre bibliothèque est vide</h2>
                                ...
                                <div>
                                    <div class="font-semibold">
                                        ...
                                        <?php elseif ($activity['action'] == 'finished'): ?>
                                            Vous avez terminé
                                        <?php endif; ?>
                                        <a href="../book.php?id=<?php echo $activity['book_id']; ?>" class="text-blue-600 hover:underline">
...
// Ajouter ce code JavaScript à la fin du script existant dans my-library.php
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (success) {
                        ...
                        // Afficher un message d'erreur mais ne pas bloquer la suppression
